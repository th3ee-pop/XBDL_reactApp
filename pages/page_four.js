...
export default class Page_4 extends Component {
    ...
    myQuestions = new QuestionList().questions[3];
    ...
    handleChange(index, answers) {
        ...
        this.props.handleChange(3, this.virtualState.answers, this.state.hidden);
        this.getCompletion();
    }
    ...
    getCompletion() {
        ...
        this.props.submitCompletion(3, validAnswer.length, hasAnswer.length);
    }
