...
export default class Page_5 extends Component {

    myQuestions = new QuestionList().questions[4];
    ...
    handleChange(index, answers) {
        ...
        this.props.handleChange(4, this.virtualState.answers, this.state.hidden);
        this.getCompletion();
    }
    ...
    getCompletion() {
        ...
        this.props.submitCompletion(4, validAnswer.length, hasAnswer.length);
    }
